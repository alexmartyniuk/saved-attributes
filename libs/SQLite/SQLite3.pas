...
function SQLite3_GetTable(db: TSQLiteDB; SQLStatement: PAnsiChar; var ResultPtr: TSQLiteResult; var RowCount: Cardinal; var ColCount: Cardinal;
  var ErrMsg: PAnsiChar): integer; cdecl; external SQLiteDLL name 'sqlite3_get_table';
...
function SQLite3_Backup_Init(DestDb: TSQLiteDB; DestDbName: PAnsiChar; SourceDb: TSQLiteDB; SourceDbName: PAnsiChar): TSQLiteBackup; cdecl;
  external SQLiteDLL name 'sqlite3_backup_init';
...
function sqlite3_bind_text16(hStmt: TSQLiteStmt; ParamNum: integer; Text: PWideChar; numBytes: integer; ptrDestructor: TSQLite3Destructor): integer; cdecl;
  external SQLiteDLL name 'sqlite3_bind_text16';
